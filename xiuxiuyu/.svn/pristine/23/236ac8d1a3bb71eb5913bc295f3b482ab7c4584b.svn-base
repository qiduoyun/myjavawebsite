...
<body>
   ...
   <div style="width:820px;margin-left:20px;margin-top:20px;">
		<form action="/content/add.do" id="ff" method="post">
		    ...
		    <div style="margin-bottom:20px">
			    ...
			    <script type="text/javascript">
			       function setSelectValue(node,data){
			    	   var s_node=$('#channel_tree').tree('getSelected');
			    	   var value=s_node.id|1;
			    	   $('#channel-id').combotree('setValue',value);
			       }
			    </script>
			</div>
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" name="title" style="width:500px" data-options="label:'内容标题',required:true,onChange:getKeyword">
			</div>
			<script type="text/javascript">
			    //拆分标题关键词
			...
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" name="author" style="width:200px" data-options="label:'作者'">
			</div>
			<div style="margin-bottom:20px">
				<input id="keyword" class="easyui-textbox" name="keyword" style="width:500px" data-options="label:'关键词'">
			</div>
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" name="description" style="width:800px;height:60px" data-options="label:'内容描述',multiline:true"">
			</div>
			...
			<div style="margin-bottom:20px">
			<input id="imgPath" class="easyui-textbox" name="imgPath" label="类型图" style="width:300px"/>
			     <a style="display:block;width:67px;margin-top:20px;margin-left:85px;padding-left:1px;cursor: pointer;border:2px solid #95B8E7;border-radius:5px;">
			       <span id="spanButtonPlaceHolder" class="btnText"></span>
			     </a>
			...
			<div style="margin-bottom:20px">
			    <input id="videoPath" class="easyui-textbox" name="filePath" label="视频" style="width:300px"/>
			    ...
			    <a style="display:block;width:57px;margin-top:20px;margin-left:85px;padding-left:1px;cursor: pointer;border:2px solid #95B8E7;border-radius:5px;">
			      <span id="spanButtonPlaceHolder2" class="btnText"></span>
			    </a>
	...
	$(document).ready(function() {
		...
		swfu=new SWFUpload({
			...
			button_text_style: '.swfupload{color:#666666;text-align: center;cursor: pointer;background-color: #13c58d;}',
